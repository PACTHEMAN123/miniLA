...
typedef enum { OP_ADD, OP_SLT, OP_SLTU, OP_NOR , OP_AND, OP_OR, OP_XOR, OP_SLL, OP_SRL, OP_SUB, OP_SRA, OP_BREAK, OP_SYSCALL, OP_INVALID } alu_op_t;
typedef enum { MEM_LB, MEM_LBU, MEM_LH, MEM_LHU, MEM_LW, MEM_SB, MEM_SH, MEM_SW, MEM_INVALID } mem_op_t;
